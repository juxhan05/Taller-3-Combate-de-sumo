package pa.taller3.cliente.modelo;

/**
 * Representa una técnica de combate en el sumo (Kimarite).
 *
 * <p>
 * Un Kimarite tiene nombre y descripción. Las técnicas son cargadas desde un
 * archivo {@code .properties} y asignadas al luchador según su especialidad.
 * Las tecnicas son cargadas desde un archivo .properties.</p>
 *
 *
