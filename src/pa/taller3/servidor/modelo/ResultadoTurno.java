 ...
 *
 * <p>
 * Cuando un luchador ejecuta su turno en el {@link Dohyo}, se produce un
 * resultado: la técnica usada y si logró sacar al rival. Esta clase transporta
 * esos dos datos de vuelta al hilo que ejecutó el turno.</p>
...
public class ResultadoTurno {
     ...
     */
    public Kimarite getTecnicaUsada() {
        return tecnicaUsada;
    }
     ...
     */
    public boolean isSacoAlOponente() {
        return sacoAlOponente;
    }
}
